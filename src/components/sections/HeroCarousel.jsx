          ...
          <div className="absolute inset-x-0 bottom-16 md:bottom-24 z-20">
            <div className="container mx-auto px-4 md:px-8 lg:px-12">
              <div className={cn("max-w-4xl transition-all duration-1000 delay-300 transform", index === current ? "translate-x-0 opacity-100" : "-translate-x-10 opacity-0")}>
                ...
                <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-display font-black text-white uppercase leading-[1.2] drop-shadow-2xl mb-4 md:mb-6">
                  {slide.title}<br />
                  <span className="text-un-gold">{slide.subtitle}</span>
                </h1>
