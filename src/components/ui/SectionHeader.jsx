...
export const SectionHeader = ({
  ...
  <div className={cn("flex flex-col lg:flex-row justify-between items-start lg:items-end mb-10 md:mb-14 lg:mb-16 gap-8", className)}>
    <div className="max-w-4xl">
      ...
      <h2 className={cn(
        "text-3xl md:text-5xl lg:text-6xl font-display font-black uppercase tracking-tight leading-[1.15] mb-0 pb-0 overflow-visible",
        inverted ? "text-white" : "text-gray-900"
      )}>
        {title} {titleAccent && <br className="hidden md:block"/>}
        {titleAccent && (
          <span className={cn(
            "text-transparent bg-clip-text bg-gradient-to-r inline-block px-0.5 pb-2",
