        ...
        {sections.map((s) => {
          ...
          return (
            <a
              ...
              className={cn(
                'whitespace-nowrap text-xs font-bold uppercase tracking-[0.18em] px-4 py-2 rounded-full transition-all duration-300',
                isActive
...
export const MovimentoPage = ({ slug, navigate }) => {
  ...
  return (
    <div className="animate-fade-in">
      ...
      <section id="oque-e" className="py-12 md:py-20 bg-slate-50/60 scroll-mt-24">
        <div className="container mx-auto px-4 md:px-8 lg:px-12">
          <div className="relative glass-near rounded-[3rem] p-8 md:p-14 lg:p-16 border border-slate-200/80 bg-white shadow-2xl overflow-hidden">
      ...
      <section id="compromissos" className="py-12 md:py-20 bg-white border-t border-slate-100 scroll-mt-24">
        <div className="container mx-auto px-4 md:px-8 lg:px-12">
          <SectionHeader
      ...
      <section id="como-funciona" className="py-12 md:py-20 bg-slate-50/60 border-t border-slate-100 scroll-mt-24">
        <div className="container mx-auto px-4 md:px-8 lg:px-12">
          <div className="flex items-center gap-3 mb-5">
            <span className="w-3.5 h-3.5 rounded-full" style={{ backgroundColor: mov.color }} />
            <span className="text-[11px] font-bold uppercase tracking-[0.25em] text-slate-400">
